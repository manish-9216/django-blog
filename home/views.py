...
def blogs_comments(request, slug):
    ...
    if request.method=="POST":
        ...
        comment.save()
    return render(request, "blog_comments.html", {'post':post, 'comments':comments,'link':link})
...
def Share_post(request):
    if request.method=='POST':
        link=request.POST['linkname']
        email=request.POST['email']
        email = EmailMessage('Subject', link, to=['your@email.com'])
        email.send()
    return redirect('/')
